...
{
  internal static IEnumerable<MenuItem> MixedArithmeticOperatorsGroupItems(ContextualContext context)
  {
    var psuedoGenericTypes = context.World.GetPsuedoGenericTypesForWorld();
    var group = psuedoGenericTypes.MixedArithmeticOperators().ToDictionary();
