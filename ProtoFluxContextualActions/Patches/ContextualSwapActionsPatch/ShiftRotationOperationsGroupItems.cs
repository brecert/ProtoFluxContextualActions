...
{
  internal static IEnumerable<MenuItem> ShiftRotationOperationsGroupItems(ContextualContext context)
  {
    var psuedoGenericTypes = context.World.GetPsuedoGenericTypesForWorld();
    var group = psuedoGenericTypes.ShiftRotationOperations().ToDictionary();
